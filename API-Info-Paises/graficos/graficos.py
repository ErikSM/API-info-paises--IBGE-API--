...
def bars_graphic_ramp_up(dictionary, x_axle_name='x', y_axle_name='y', graphic_name='grafico', y_mask=""):
...
def lines_graphic_ramp_up(dictionary, x_axle_name='x', y_axle_name='y', graphic_name='grafico', y_mask=""):
    plt.figure(figsize=(10, 6), facecolor='grey')
    plt.axes().set_facecolor('grey')
    plt.tick_params(axis='x', labelsize=8)
    plt.tick_params(axis='y', labelsize=8)
