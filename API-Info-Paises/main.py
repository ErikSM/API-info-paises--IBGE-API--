...
class Projecoes:
    ...
    def __init__(self):
        ...
        self.texto = Text(self.window, font="Arial 9 bold", width=100, height=20, bg="grey90", bd=3)
        self.texto.pack()
        ...
        self.label_text = Label(self.sub_frame_equerdo, bg="grey90",
        ...
        self.list = Listbox(self.sub_frame_direito, width=90, height=9, bd=2, bg="grey90")
